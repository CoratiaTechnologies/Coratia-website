          ...
          <div className="mt-8 mx-4 grid grid-cols-1 md:grid-cols-3 gap-20 ">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <p className="mt-4 md:pr-6 text-base">
                We create possibilities for the connected
                world. Be Bold.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="flex flex-col items-center md:items-start">
                <h3 className="text-xl font-medium text-[rgb(0,157,201)]">COMPANY</h3>
                <ul className="mt-2 space-y-2 text-white">
                  <li>
                    <a className="text-base hover:text-gray-400 transition" href="#">
                      Contact
                    </a>
                  </li>
                  <li>
              ...
              <div className="flex flex-col items-center md:items-start">
                <h3 className="text-xl font-medium text-[rgb(0,157,201)]">SOCIAL</h3>
                <ul className="mt-2 space-y-2 text-white">
                  <li>
                    <a className="text-base hover:text-gray-400 transition" href="#">
                      Twitter
