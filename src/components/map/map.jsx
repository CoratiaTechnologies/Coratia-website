...
export default function Map() {
  return (
    <div id="contact" className="bg-white text-black px-5 md:px-10 py-5">
      <div className="w-[100%] flex flex-wrap">
        ...
        <div className="mt-2 md:mt-0 mx-auto md:pl-20 md:w-[40%]">
          ...
          <p className="md:mt-5 mt-2 text-base md:text-lg md:w-[80%]">
            Coratia Technologies Pvt. Ltd. Foundation for Technology & Business
